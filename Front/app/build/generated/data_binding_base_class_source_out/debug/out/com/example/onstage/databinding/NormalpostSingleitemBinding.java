...
public final class NormalpostSingleitemBinding implements ViewBinding {
  @NonNull
  ...
  private NormalpostSingleitemBinding(@NonNull CardView rootView, @NonNull TextView cmnts,
  ...
  @NonNull
  public static NormalpostSingleitemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static NormalpostSingleitemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.normalpost_singleitem, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static NormalpostSingleitemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new NormalpostSingleitemBinding((CardView) rootView, cmnts, description, likes,
          postName, postPic, postRole);
    }
